...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0gglv04.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0gglv04.containers.anotherwebservice.com/
...
```
git clone git@github.com:paumor5/container-0gglv04.git
cd container-0gglv04
```
...
```
docker attach container-0gglv04
```
